      ...
      <div className="grid w-full grid-cols-1 gap-5 mt-12 lg:grid-cols-2">
        ...
        <div className="border rounded-lg border-black-300 bg-black-200 h-96 md:h-full">
          <Canvas>
            ...
            <OrbitControls
              // maxPolarAngle is the maximum angle from the positive z-axis that the camera can be moved to
              // by the user. In this case, we want the user to be able to look directly up at the top of
              // the computer, so we set it to Math.PI / 2 (90 degrees)
