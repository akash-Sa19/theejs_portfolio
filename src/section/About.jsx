...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("akashsahu793@gmail.com");
    setHasCopied(true);
    setTimeout(() => {
      setHasCopied(false);
    }, 2000);
          ...
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                ...
                abd development, with a focus on animation 3D wensites.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-1 xl:row-span-4">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                I am based in India, and remote work available
              </p>
              <Button
                name="Contact Me"
                isBeam
            ...
            <div className="space-y-2">
              ...
              >
                <img
                  ...
                  alt="copy"
                />
                <p className="font-medium text-white lg:text-xl md:text-lg text-gray_gradient">
                  akashsahu793@gmail.com
                </p>
              </div>
            </div>
          </div>
